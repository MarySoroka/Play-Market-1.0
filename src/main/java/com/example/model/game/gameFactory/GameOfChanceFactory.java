...
public class GameOfChanceFactory implements GameFactory {
    @Override
    public Game createGame(String[] data) {
        try {
            return new GameOfChance(data[0],data[1],new SimpleDateFormat("dd/mm/yyyy").parse(data[2]),
